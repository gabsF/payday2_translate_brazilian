Hooks:Add("LocalizationManagerPostInit", "milharesdedolaresvindovoando", function(loc)
	...
	pln_man_21_03 = "Droga, eles viram a gente! Vamos entrar em ação pessoal!",
	...
	pln_man_58_01 = "Cuidado com o pescoço!",
	pln_man_11_02 = "Ok, fiquem de olho no que tá acontecendo. Nós precisamos realmente ver esse servidor.",
	pln_man_05_01 = "A outra festa agora está a um minuto.",
	pln_man_34_01 = "Cuidado pessoal, está balançando!",
	pln_man_26_03 = "Ouviram isso? É o C4! Eles estão abrindo passagens!",
	...
	pln_man_32_01 = "OK, para o telhado agora!",
	pln_man_22a_03 = "Como está, Alex? Recomponha-se!",
	pln_man_39_03 = "Ele ainda deve estar vivo, certo? ",
	pln_man_78_02 = "Vamos pessoal! Vocês conseguem!",
	pln_man_03_03 = "O cara de camisa branca, é ele, é o nosso contribuinte.",
	pln_man_36_01 = "Sem tempo a perder, atirem nos cabos e o derrubem.",
	pln_man_22a_01 = "Alex, recomponha-se já!",
	...
	pln_man_17_03 = "Que merda! Se protejam!",
	pln_man_54_02 = "Deem uma pancada na cabeça dele!",
	pln_man_03_01 = "Olhem pela janela - O contribuinte é o cara de camisa branca.",
	pln_man_36_03 = "Vão, atirem nos cabos!",
	pln_man_71_01 = "Ok, peguei o recibo, tudo limpo. Último passo. Quando o tempo acabar - é a hora de fazer uma boa grana.",
	pln_man_55_03 = "Agora precisamos das senhas.",
	pln_man_13_01 = "Ele colocou-o debaixo da camisa.",
	pln_man_52_01 = "Está no quarto andar.",
	pln_man_01_01 = "Lembrem-se que nós precisamos tanto do servidor quanto do contribuinte, pessoal. Deem um susto e façam ele entrar na limousine uma vez que nós já tenhamos confirmado que ele está com o servidor.",
	...
	pln_man_34_03 = "Cuidado! O teto está prestes a cair!",
	pln_man_27_02 = "A SWAT já está no prédio, estão vindo pela escadaria da direita.",
	pln_man_16_02 = "Lembrem-se! Não atirem de fato no contribuinte, só o forcem a entrar na limousine. Atirem apenas para intimidar.",
	...
	pln_man_35_03 = "Merda, ficou preso. Tentem atirar nos cabos.",
	...
	pln_man_35_02 = "Ah, está preso. Não dá para chegar. Atirem nos cabos!",
	...
	pln_man_20_01 = "Helicóptero na área. Ah não, eles vão ver o Alex! Se escondam!",
	pln_man_76_03 = "Vão para o telhado e corram para o telhado de conexão.",
	pln_man_78_01 = "Vocês precisam fazer esse pulo, pessoal!",
	pln_man_20_02 = "Um helicóptero está se aproximando. Porra, eles vão ver o Alex!",
	pln_man_02_02 = "Que... isso deve ser o scanner da polícia, os policiais estão em algum lugar próximo daqui.",
	...
	pln_man_26_05 = "Eles estão usando o C4 para demolir as paredes!",
	...
	pln_man_60_02 = "Se certifiquem de que ele ainda esteja respirando!",
	pln_man_76_02 = "Vão para o telhado e fujam pela construção na esquerda. O Alex está vindo de helicóptero.",
	pln_man_19_03 = "Eu vejo nove deles.",
	pln_man_73_02 = "Excelente! Eu acabei de confirmar a transação de 25 milhões de dólares!",
	pln_man_10_01 = "Eu conto quatro caras.",
	pln_man_06_01 = "O cliente está apenas a alguns blocos daí agora, deve chegar em dois minutos!",
	...
	pln_man_22_01 = "OK, o Alex vai tirar ela daí. Não se deixem serem pegos de surpresa. Preparem-se!",
	...
	pln_man_02_01 = "Uhh.. Isso deve ser um scanner da polícia. Vou desligar. A polícia está apenas a algumas milhas.",
	...
	pln_man_00a_02 = "Para deixar claro: O contribuinte é a IRS fazendo acordo com alguma empresa corrupta. Ele está vendendo um servidor para eles com informações vitais.",
	pln_man_00a_03 = "Nós acabamos com eles, peguem tanto o servidor quanto o contribuinte. Com isso, poderemos conseguir os 25 milhões. Alex, o guindaste já tá pronto?",
	pln_man_00b_01 = "Ok pessoal, no momento certo, interrompam o acordo. Então o Alex tira a limousine dali. Fiquem prontos!",
	pln_man_01_02 = "Pessoal, nós temos que fazer isso do jeito certo; precisamos tanto do contribuinte quanto do servidor, caso contrário, tudo vai a merda. Certifiquem-se de que ele está com o servidor.",
	...
	pln_man_05_02 = "O cliente está a um minuto daí.",
	...
	pln_man_10_02 = "São quatro caras.",
	...
	pln_man_15_02 = "Sim, esse é o servidor! 25 milhões de dólares pessoal! Agora nós precisamos colocar as mãos no servidor e pegar as senhas.",
	...
	pln_man_19_01 = "Filhos da... Eu contei nove caras.",
	pln_man_19_02 = "Aí tem coisa... Eu vejo pelo menos uns nove caras.",
	pln_man_21_02 = "Nós estamos comprometidos! Entrem em ação pessoal!",
	pln_man_22a_02 = "Vamos, Alex, anda logo!",
	pln_man_22_03 = "Certo. Alex, use o guindaste.",
	...
	pln_man_24_01 = "Agora nós teremos que ir às cegas. Façam certo!",
	pln_man_24_02 = "Pessoal! Foi cedo de mais, e se o servidor não estiver lá?",
	pln_man_25_01 = "Certo, sentem ele na cadeira aí.",
	...
	pln_man_29_02 = "A SWAT está vindo pela escadaria da esquerda, no térreo.",
	...
	pln_man_31_01 = "As saídas de ar! As saídas de ar! Verifiquem as saídas de ar!",
	...
	pln_man_38_01 = "Alex! Eu sou um completo idiota por contratar você de novo.",
	...
	pln_man_44_01 = "A IRS fazendo contratos corruptos com grandes empresas. Maravilha, eu me sinto como o Robin Hood nesse momento.",
	pln_man_44_02 = "Vocês poderiam discutir que somos os caras bonzinhos nessa situação, certo?",
	pln_man_44_03 = "Olhem para nós, interrompendo um acordo corrupto entre a IRS e uma grande empresa: nós somos como o Robin Hood!",
	...
	pln_man_48_03 = "Peguem o servidor, sem ele, tudo vai por água a baixo!",
	...
	pln_man_56_01 = "Ótimo, hehe. Ele teve o que mereceu!",
	pln_man_57_02 = "Peguem leve agora!",
	pln_man_57_03 = "Ok, peguem um pouco mais leve, nós não queremos que ele acabe morrendo.",
	...
	pln_man_63a_01 = "Digitem MercyKill.",
	...
	pln_man_69_02 = "Certo, nós passamos da ASIM. Eles não vão nem saber o que pegou eles.",
	pln_man_69_03 = "ASIM - Pronto! Nós estamos indo!",
	pln_man_70_03 = "Ok, está verificando a autenticidade. Talvez demore um pouco, então fiquem de olho no tempo.",
	pln_man_71_02 = "Pessoal, consegui um recibo da conta da empresa. Quando o tempo acabar, estaremos limpos para completar a transação.",
	pln_man_71_03 = "Esse é o recibo, parece que funcionou. Quando o tempo acabar, nós estaremos ricos senhoras e senhores.",
	pln_man_72_01 = "Pronto! Terminamos de hackear. Me dê.. Me dê.. Me dê.. Me dê...",
	pln_man_72_02 = "Sim! Dinheiro, dinheiro, dinheiro, dinheiro - DINHEIRO!",
	pln_man_72_03 = "Aí está! Hora de pegar uma boa grana, baby!",
	pln_man_73_01 = "Fantástico! Acabei de confirmar a transação de 25 milhões.",
	pln_man_74_01 = "Lá vamos nós. Dinheiro de impostos sendo usados para uma boa causa.",
	pln_man_75_02 = "Pronto, hora de dar o fora daí.",
	pln_man_76_01 = "Vão para o telhado e corram para o terraço de conexão.",
	pln_man_77_03 = "Rápido, pessoal!",
	pln_man_78_03 = "Sim, vocês precisam ser um Persian para fazer esse pulo!",
	pln_man_79_01 = "Merda! Gás! Gás!",
	...
	crn_man_intro_01 = "Guindaste está pronto.",
	...
	txm_man_01_01 = "Está perto. Posso ver o dinheiro?",
	txm_man_01_02 = "Está logo aqui perto. Eu quero ver o dinheiro.",
	...
	hud_heist_man5 = "Tire o contribuinte da limousine! Use a serra para abrir o teto e tire-o de lá.",
	hud_heist_man5_hl = "Use a Serra na Limousine",
	hud_heist_man6 = "Precisamos tirar o contribuinte e levá-lo para a sala de transferência para começar. Use toda a força necessária para fazer ele cooperar.",
	hud_heist_man6_hl = "Leve o Contribuinte para a Sala de Transferência",
	hud_heist_man7 = "Pegue o servidor da limousine e vá para sala de transferência para conectá-lo.",
	hud_heist_man7_hl = "Pegue o Servidor e Conecte-o",
