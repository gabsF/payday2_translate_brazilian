Hooks:Add("LocalizationManagerPostInit", "vamostodosimprimirdinheiro", function(loc)
	...
	pln_pal_80_09 = "Hamburgueres do Almir, em que posso ajudá-lo?",
	...
	pln_pal_23_01 = "Agora vocês se fuderam, vão para o plano B!",
	...
	pln_pal_23_03 = "Droga! Lá se vai o Stealth - hora da ação. Preparem-se para terem um pouco de companhia!",
	...
	pln_pal_09_01 = "Droga, os policiais desligaram o dispositivo de hackeamento! Vocês vão precisar reiniciá-lo!",
	...
	pln_pal_01_01 = "Nós estamos aqui pelas placas. Eles imprimiram uma fortuna nos útimos meses, gastaram que nem loucos. O sangue está na água e nós somos os tubarões!",
	...
	pln_pal_17_01 = "Quem atirou? Agora vocês se fuderam. Vão para o plano B!",
	...
	pln_pal_24_02 = "Os policiais da Flórida não estão para brincandeira. Eles querem fazer uma boa primeira impressão.",
	...
	pln_pal_30_01 = "Então esse é o plano, fazer um pegueno buraco no topo do cofre, pegar uma mangueira de jardim para encher o cofre com água e jogar um pouco de C4 dentro. Após isso vocês peguem o que tiver dentro do cofre e fujam. Ao trabalho, pessoal!",
	...
	pln_pal_81_01 = "Nesse mundo fudido, dinheiro falso ainda vale muito. Ótimo trabalho!",
