Hooks:Add("LocalizationManagerPostInit", "qualbuildeuusoprodsod", function(loc)
	...
	skill_tree_reset_skills_button = "[F] (ou ) para resetar só essas Habilidades ",
	...
	menu_shotgun_cqb_beta_desc = "BÁSICO: ##$basic##\nVocê irá recarregar a sua Espingarda ##15%## mais rápido. \n\nAVANÇADO: ##$pro##\nVocê irá recarregar a sua Espingarda ##25%## mais rápido. Você também irá conseguir mirar com a Espingarda ##125%## mais rápido.",
	--menu_shotgun_impact_beta = "Shotgun Impact",
	menu_shotgun_impact_beta_desc = "BÁSICO: ##$basic##\nA sua estabilidade com as Espingardas é aumentada em ##8##. Você irá causar ##5%## a mais de dano com as Espingardas. \n\nAVANÇADO: ##$pro##\nVocê irá causar ##10%## a mais de dano com as Espingardas.",
	--menu_close_by_beta = "Close By",
	menu_close_by_beta_desc = "BÁSICO: ##$basic##\nAgora você vai poder correr e atirar ao mesmo tempo com as Espingardas. \n\nAVANÇADO: ##$pro##\nVocê poderá atirar ##35%## mais rápido enquanto não mira com o modo de um tiro com as Espingardas. Espingardas com carregadores terão mais ##15## balas extras.",
	--menu_far_away_beta = "Far Away",
	menu_far_away_beta_desc = "BÁSICO: ##$basic##\nA sua precisão com as suas Espingardas é aumentada em ##40%## enquanto mira. \n\nAVANÇADO: ##$pro##\nVocê ganha um alcance efetivo de ##50%## enquanto mira com as Espingardas.",
	--menu_overkill_beta = "Overkill",
	menu_overkill_beta_desc = "BÁSICO: ##$basic##\nQuando você mata alguém com uma Espingarda ou com a ##OVE9000 Saw##, você receberá um grandioso bônus de ##75%## a mais de dano por ##20## segundos. \n\nAVANÇADO: ##$pro##\nO bônus do dano será aplicado para todas as armas, mas o bônus ainda precisa ser ativada usando uma Espingarda ou a Serra. A sua velocidade de trocar as armas é aumentada em ##80%## \n\nNota: Isso não se aplica a dano da arma corpo-a-corpo, granadas, lança-granadas ou RPGs.",
	...
	menu_second_chances_beta_desc = "BÁSICO: ##$basic##\nGanha a Habilidade de desativar ##1## Câmera de segurança de detectar você e os seus aliados. O efeito dura até ##25## segundos. \n\nAVANÇADO: ##$pro##\nO tempo para se destrancar fechaduras/travas é ##100%## mais rápido. Você também ganha a habilidade de destrancar cofres.",
