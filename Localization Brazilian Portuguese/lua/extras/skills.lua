Hooks:Add("LocalizationManagerPostInit", "qualbuildeuusoprodsod", function(loc)
	...
	skill_tree_reset_skills_button = "[F] (ou ) para Resetar Árvore de Habilidades",
	...
	nx64_reset_skills_msg = "Você está prestes a redefinir uma ou todas as suas árvores de habilidades.$NL;$NL;Selecionar a opção de RESETAR ÁRVORE irá remover os pontos de habilidade da árvore selecionada e irá retorná-los para você.$NL;$NL;Selecionar a opção de RESETAR TUDO irá remover todos os pontos de habilidade de todas as árvores e irá retorná-los para você.",
	dialog_respec_skilltree = "Você está prestes a resetar todos os pontos dessa árvore de habilidades.\n\nConcluir essa ação fará você resetar os seus pontos de habilidade dessa árvore em $tree.",
	dialog_respec_skilltree_all = "Você está prestes a resetar todas as árvores de habilidades.\n\nConcluir essa ação fará você resetar todos os seus pontos de habilidade de todas as árvores.",
