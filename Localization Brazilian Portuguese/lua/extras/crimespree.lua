Hooks:Add("LocalizationManagerPostInit", "sequenciaderoubos", function(loc)
	...
	menu_cs_ga_increased_body_bags_desc = "Jogadores vão receber e podem carregar mais 2 Bolsas de Cadavéres.",
	...
	menu_cs_ga_increased_lives_desc = "Todos os jogadores agora tem 1 queda extra antes de irem para custódia.",
