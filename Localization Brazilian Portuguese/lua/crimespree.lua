Hooks:Add("LocalizationManagerPostInit", "sequenciaderoubos", function(loc)
	...
	menu_cs_ga_increased_lives_desc = "Todos os jogadores agora tem $lives quedas extras antes de irem pra custódia.",
	...
	menu_cs_ga_increased_stamina_desc = "Todos os jogadores recebem $stamina% de Resistência extra.",
	menu_cs_ga_quick_switch = "Troca Apressado",--Swift Swapper
	menu_cs_ga_life_steal_desc = "Jogadores vão recuperar vida quando matarem um inimigo. Isso só pode ocorrer uma vez a cada $cooldown segundos.",
	...
	menu_cs_ga_limit_reached = "No Limite",--Limit Reached
	menu_cs_ga_increased_stamina = "Aumento de Resistência",--Stamina Boost
	menu_cs_ga_increased_ammo_desc = "Todos os jogadores vão receber $ammo% mais de munição.",
	...
	menu_cs_ga_increased_deployables_desc = "Todos os jogadores recebem $deployables% de equipamentos extra. (Minímo: 1)",
	menu_cs_ga_increased_lives = "Só Mais Uma Queda",--One More Down
	menu_cs_ga_quick_locks_desc = "Jogadores destranquem $speed% mais rápido.",
