return {
	...
	heist_kosugi_crimenet = "A Murkywater possui um armazém alfandegado lá no antigo caís. Veja que tipo de merda eles estão devolvendo para o exterior.$NL;$NL;» Invada o Armazém sem ser Detectado.$NL;» Roube qualquer item valioso que você puder encontrar$NL;» Lembre-se: Não há Plano B$NL;» Fuja com os espólios",
	...
	pln_ko1_25_01 = "Um dos caras do Gage está em um estacionamento próximo. Vocês podem jogar os espólios por cima do muro pra ele.",
	pln_ko1_03_02 = "Esse é o armazém. Vocês podem apostar que os melhores espólios estão aqui.",
	...
	pln_ko1_22_03 = "Acho que é a armadura de Oda Nobunaga. Isso é super valioso, gangue. Peguem!",
	pln_ko1_24_03 = "O Gage ordenou uma caçamba de lixo para guardar um pouco dos espólios. O pessoal dele irá recolhê-la pela manhã.",
	pln_ko1_03_01 = "Fiquem atento, cavalheiro. O armazém será mais difícil, mas as recompensas vão valer a pena.",
	...
	pln_ko1_03_03 = "Vocês estão no Covil da Besta, gangue. Os melhores espólios, porém com um grau absurdo de risco.",
	...
	pln_ko1_25_02 = "Um associado do Gage vai nos ajudar a tirar parte do espólio. Apenas joguem pra ele.",
	...
	pln_ko1_16_01 = "Esses contêineres da Murkywater são trazidos de diferentes pontos do mundo. Abram-os. Eles serão sua melhor aposta para acharem espólio.",
	...
	pln_ko1_25_03 = "O cara do Gage está em um estacionamento próximo. Joguem os espólios por cima do muro pra ele.",
	...
	hud_heist_kosugi_hl = "Pegue o espólio do Depósito",
	hud_heist_kosugi = "Roube o máximo de espólio possível do depósito. Mantenha-se em silêncio.",		
