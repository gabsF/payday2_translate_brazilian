return {
	...
	menu_deck3_3_desc = "Você ganha ##$multiperk;## mais de armadura.",--You gain an additional ##$multiperk;## more armor.
	menu_deck3_5 = "Tipo III de Colete",
	menu_deck3_5_desc = "Você ganha ##$multiperk;## mais de armadura.",--You gain an additional ##$multiperk;## more armor.
