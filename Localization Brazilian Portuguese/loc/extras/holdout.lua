return {
	...
	heist_skm_big2_briefing = "Nós estamos indo para o Banco Benevolent. Desta vez não estamos indo pro cofre, nós iremos sequestrar um refém e nós tomaremos cuidado que nenhum policial o resgatarão. Mantenham a calma e nós iremos ter um bom dinheiro disso.",
	--We're going to the Benevolent Bank. This time we're not after the vault, we're going to take a hostage and watch the kerels smash themselves blood trying to rescue them. Keep your heads cool and we'll get a good payday out of this.",
	heist_skm_run_briefing = "Os policiais recentemente interrogaram um prisioneiro, ele diz que viu o rosto do Bain e pode identificar ele. Nós sabemos que isso é uma mentira, mas os policiais não, nem mesmo os nossos rivais, então vamos abusar a situação para ter um dinheiro extra. Interceptem os idiotas enquanto eles transportam o prisioneiro para proteção de testemunha, próximo à um ferro-velho onde aquele idiota do Matt acidentou enquanto fugia da gente. Isso vai dar um dinheiro dos bons.",
	--The kerels recently interrogated a prisoner that claims to have seen the face of Bain and can identify him. While we know it isn't true, the kerels don't, and neither do our rivals, so we're going to use the situation to gain some cash. Intercept the chop while they're transferring him to witness protection, near the old factory storage yard where that dumkop Matt crashed his car while trying to get away from us. Should give us a nice, juicy ransom.",
